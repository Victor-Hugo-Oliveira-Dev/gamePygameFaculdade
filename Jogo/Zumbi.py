...
class Zumbi(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        # Sistema de combate
        self.detection_radius = 250  # Raio de detecção do jogador
        self.attack_range = 50       # Alcance do ataque
        self.is_attacking = False
        self.is_taking_damage = False
        self.is_dead = False
        
        # Hitbox (ajustável)
        self.collision_rect = pygame.Rect(0, 0, 50, 75)  # Largura e altura personalizadas
    ...
    def update(self, player_rect):
        ...
        # Verifica se o jogador está fora do raio de detecção
        ...
        if not self.is_attacking and not self.is_taking_damage:
            ...
            if distance < self.attack_range:
                ...
                # Atualiza animação de movimento apenas se estiver se movendo
